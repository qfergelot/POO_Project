...
public class Main extends Application {
	...
	public void start(Stage primaryStage) {
		...
		gameLoop = new AnimationTimer() {
			...
			public void handle(long now) {
				...
				/************IDEE DE DINGUE
				 * Creer une variable dans UIsingleton qui dit si un update a besoin d'√™tre fait
				 */
	...
	private void loadGame() {
		try {
			...
			System.out.println("Le fichier de sauvegarde n'a pas ÈtÈ trouvÈ !");
		}
	}
 ...
 */
/* setX -> pas bonne coordonn√©e : boucle pour demander nouvelle coordonn√©e?
 * Pas bien car ce n'est pas forc√©ment un humain qui va appeler un setter
 */
